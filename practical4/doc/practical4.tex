...
%       TITLE SECTION
%----------------------------------------------------------------------------------------
\title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{Practical 4: Write a program in any language to create LL(1) Parser}} % Article title
\author{
	\large
...
\section{\LARGE AIM}
A Code that generate First() and Follow() of any Context free Grammars and then create Parsing table to trace any language constructs.
