...
%       TITLE SECTION
%----------------------------------------------------------------------------------------
\title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{Practical 6: Write a program to generate 3 Address Code (Intermediate Representation) of any C Code.}} % Article title
\author{
	\large
...
\section{\LARGE AIM}
Write a program to generate 3 Address Code (Intermediate Representation) of any C Code.
...
\subsection{Input}
\inputminted{text}{../6.in}

\subsubsection{Output}
\inputminted{text}{../6.out}
